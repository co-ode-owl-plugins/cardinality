...
public class CardinalityRowEditor extends JPanel {
    ...
    private final Map<String, CardinalityRowEditorPanel> editors = new HashMap<>();
    ...
    public CardinalityRowEditor(OWLEditorKit eKit, OWLClass subject) {
        ...
        editors.put("Data Constant",
                new DataConstantFillerRowEditor(eKit, subject));
        tabbedPane = new JTabbedPane();
        tabbedPane.setFocusable(false);
        final java.util.List<String> editorNames = new ArrayList<>(
                editors.keySet());
    ...
    public int showDialog(OWLClass subject) {
        ...
        return JOptionPane.showConfirmDialog(
                eKit.getWorkspace().getTopLevelAncestor(), this,
                "Create New Row", JOptionPane.OK_CANCEL_OPTION,
                JOptionPane.PLAIN_MESSAGE);
    }

    public CardinalityRow createRow() {
        CardinalityRowEditorPanel activePanel = (CardinalityRowEditorPanel) tabbedPane
